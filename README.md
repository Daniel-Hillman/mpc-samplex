...
For now the app is a browser-based planning and auditioning tool. Use the pad recipes, note labels, and retune suggestions to recreate ideas on the MPC by hand.
